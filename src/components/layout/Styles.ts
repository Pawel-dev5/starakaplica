...
// NAVIGATION
export const StyledNavText = styled.a<{ active?: boolean; submenu?: boolean; customPadding?: string }>`
...
export const StyledNavWrapper = styled.nav<{ submenu?: boolean; hideSubMenu?: boolean }>`
	display: flex;
	align-items: center;
...
export const StyledLayoutHeader = styled.div<{ src: string }>`
	${({ src }) =>
		src &&
		css`
			margin-top: 40px;
...
export const StyledLayoutHeaderText = styled.div<{ isImg: boolean }>`
	width: 60%;
...
export const StyledBurgerWrapper = styled.div<{ asideMenu: boolean }>`
	align-items: center;
	display: flex;
	height: 100px;
	justify-content: center;
