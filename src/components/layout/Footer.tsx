...
const Footer = ({ footerItems, subMenuItems }: { footerItems: any; subMenuItems: any }) => {
	...
	return (
		<Container>
			<StyledFooter>
				...
				<StyledFooterWrapper>
					<StyledText h5 paddingdesktop="0 2.6rem">
						Informujemy, że nasza firma korzysta z&nbsp;subwencji finansowej, w ramach rządowego programu "Tarcza Finansowa
						2.0 Polskiego Funduszu&nbsp; Rozwoju dla Mikro, Małych i Średnich Firm", udzielonej przez przez PFR SA.
					</StyledText>
				...
				<StyledSubFooter>
					<StyledText center h5>
						© {year} Wszelkie prawa zastrzeżone. Nad Zalewem Restauracja & Eventy. Made by Paweł Nowecki
					</StyledText>
